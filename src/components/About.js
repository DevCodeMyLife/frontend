                    ...
                    <div className="content-wall-views">
                        <div className="wrapper-page-about">
                            ...
                            <div className="wrapper-about">
                                ...
                                <div className="about-text">
                                    <p>
                                        Я буду благодарен за любую помощь проекту, например Вы можете <a target="_blank"
                                                                                                         rel="noreferrer"
                                                                                                         href="https://ruvds.com/pay/49a7999ef9504f05ba508943ed1ef17f">пополнить
                                        сервер</a>, или <a rel="noreferrer" target="_blank"
                                                           href="https://www.tinkoff.ru/rm/shmelev_shampanov.andrey1/ZDgWF76063">счет</a>.
                                    </p>
                                    <p>
                                        <a target="_blank" rel="noreferrer"
                                           href="https://github.com/AndreySHSH">@AndreySHSH</a>
                                    </p>
                                    <p>
